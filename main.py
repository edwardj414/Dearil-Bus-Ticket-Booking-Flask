...
def userbookinglist():
    ...
    rows = cur.fetchall();
    msg = "LIST OF ALL BUSES"
    return render_template("userbookinglist.html", rows=rows, msg=msg, user=username, fl=flag)
...
def bookinglist():
    ...
    rows = cur.fetchall();
    msg = "LIST OF ALL BUSES"
    return render_template("bookinglist.html", rows=rows, msg=msg, user=username)
...
def cancellist():
    ...
    rows = cur.fetchall();
    msg = "LIST OF ALL BUSES"
    return render_template("cancellist.html", rows=rows, msg=msg, user=username)
